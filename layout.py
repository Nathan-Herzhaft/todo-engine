...
from theme import COLORS, FONT_MONO, FONT_SANS, GLOBAL_STYLE, TAB_SELECTED_STYLE, TAB_STYLE
...
def _label(text: str) -> html.Div:
    return html.Div(text, style={
        ...
        "marginBottom": "6px", "fontFamily": FONT_SANS,
    })
...
def _file_row(path: str) -> html.Div:
    return html.Div([
        html.Span(Path(path).name, style={
            "fontFamily": FONT_MONO, "fontSize": "13px",
            "color": COLORS["text"], "flex": "1",
        }),
        dbc.Button("Charger", id={"type": "btn-load-existing", "path": path}, style={
            "background": COLORS["accent"], "border": "none",
            "color": COLORS["bg"], "fontSize": "12px", "fontWeight": "600",
...
def _file_selection_ui(existing_jsons: list[str], error: str = "") -> html.Div:
    file_rows = [_file_row(p) for p in existing_jsons] or [
        html.Div("Aucun fichier .json trouvé dans le répertoire courant.",
                 style={"color": COLORS["muted"], "fontSize": "13px"})
    ]
    error_div = html.Div(error, style={
        "color": COLORS["danger"], "fontSize": "12px",
        "marginTop": "8px", "minHeight": "18px",
    }) if error else html.Div(style={"minHeight": "18px"})
    ...
    return html.Div([
        ...
        dbc.Input(id="new-repo-name", placeholder="ex: travail, perso, 2025…",
                  style=_input_style()),
        error_div,
        dbc.Button("Créer et charger", id="btn-create-repo", style={
...
def welcome_screen(existing_jsons: list[str]) -> html.Div:
    ...
    return html.Div(
        _plain_card([
            html.Div("Bienvenue dans Todo-Engine", style={
                "fontWeight": "700", "fontSize": "22px",
                "color": COLORS["text"], "marginBottom": "6px",
            }),
            html.Div("Choisissez ou créez un fichier pour commencer.", style={
                "color": COLORS["muted"], "fontSize": "14px", "marginBottom": "28px",
            }),
...
def file_modal(existing_jsons: list[str], error: str = "") -> html.Div:
    ...
    return html.Div([
        html.Div(id="modal-backdrop", style={
            ...
            "background": COLORS["overlay"], "zIndex": "200",
        }),
        html.Div(_plain_card([
            html.Div(
                html.Span("Changer de fichier", style={
                    "fontWeight": "700", "fontSize": "17px", "color": COLORS["text"],
                }),
            ...
            "zIndex": "201", "width": "520px", "maxWidth": "92vw",
...
def build_layout() -> html.Div:
    ...
    header = html.Div([
        html.Span("Todo-Engine", style={
            "fontWeight": "700", "fontSize": "20px", "color": COLORS["text"],
        }),
        html.Span(id="header-filename", style={
            "fontFamily": FONT_MONO, "fontSize": "12px", "color": COLORS["muted"],
            "marginLeft": "12px", "background": COLORS["card"],
            "padding": "2px 8px", "borderRadius": "4px",
        }),
        html.Div(style={"flex": "1"}),
        dbc.Button("Changer de fichier", id="btn-open-file-modal", style={
    ...
    tabs = html.Div(
        dcc.Tabs(
            ...
            value="tab-projects",
            children=[
                dcc.Tab(label="Projets",    value="tab-projects",
                        style=TAB_STYLE, selected_style=TAB_SELECTED_STYLE),
                dcc.Tab(label="Priorités",  value="tab-priority",
                        style=TAB_STYLE, selected_style=TAB_SELECTED_STYLE),
        ...
        style={"padding": "20px 36px 0 36px", "width": "100%", "boxSizing": "border-box"},
    )
    ...
    return html.Div([
        ...
        header,
        html.Div(id="main-content", children=[tabs, content], style={"display": "none"}),
